 ...
 * @param {Function} [callback] called when light did receive message
 */
Light.prototype.color = function (hue, saturation, brightness, kelvin, duration, callback, timeout) {
  ...
  this.client.send(packetObj, function (error, data) {
    if (timeoutHandle) {
 ...
 */
Light.prototype.getState = function (callback, timeout) {
 ...
 */
Light.prototype.getHardwareVersion = function (callback, timeout) {
  if (typeof callback !== 'function') {
 ...
 * @param {Function} callback a function to accept the data
 */
Light.prototype.getFirmwareVersion = function (callback, timeout) {
  if (typeof callback !== 'function') {
 ...
 * @param {Function} callback a function to accept the data
 */
Light.prototype.getFirmwareInfo = function (callback, timeout) {
  if (typeof callback !== 'function') {
    throw new TypeError('LIFX light getFirmwareVersion method expects callback to be a function');
  }
 ...
 * @param {Function} callback a function to accept the data
 */
Light.prototype.getWifiInfo = function (callback,timeout) {
  if (typeof callback !== 'function') {
    throw new TypeError('LIFX light getFirmwareVersion method expects callback to be a function');
  }
 ...
 * @param {Function} callback a function to accept the data
 */
Light.prototype.getWifiVersion = function (callback,timeout) {
  if (typeof callback !== 'function') {
    throw new TypeError('LIFX light getFirmwareVersion method expects callback to be a function');
  }
 ...
 */
Light.prototype.getLabel = function (callback, cache,timeout) {
  if (typeof callback !== 'function') {
 ...
 * @param {Function} [callback] called when light did receive message
 */
Light.prototype.setLabel = function (label, callback,timeout) {
  ...
  this.client.send(packetObj, function (error,message) {
    if(timeoutHandle){
      clearTimeout(timeoutHandle);
      timeoutHandle= null;
 ...
 * @param {Function} callback a function to accept the data
 */
Light.prototype.getAmbientLight = function (callback,timeout) {
  if (typeof callback !== 'function') {
